...
class ModelInferenceService {
  ...
  Future<void> setModelConfig(int index) async {
    ...
    await model.loadModel(); // Wait for the model to load
    print(
        "Model set to: ${model.runtimeType}, Interpreter: ${model.getInterpreter}");
  }
}
